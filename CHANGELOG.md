...
- `recins()` function for inserting new records into a recfile
- `recdel()` function for deleting records from a recfile
- `recset()` function for modifying field values in existing records
- `recinf()` function for inspecting recfile structure and metadata
